resource "aws_security_group" "c1_sg_base_dynamic_v1" {
  description = "managed by terraform"
  name_prefix = "c1-euc1-dynamic-base-v1-sg-"
  vpc_id      = var.vpc_id
  ...
  ingress {
    ...
    to_port         = 10050
    protocol        = "tcp"
    security_groups = [aws_security_group.c1_sg_zbx_host_v1.id]
  }
  ...
  ingress {
    ...
    ipv6_cidr_blocks = ["${local.c1_infra_euc1_prom_15_cidr6}"]
  }
