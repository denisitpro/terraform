...
data "aws_iam_policy_document" "c1_infra_aws_backup_service_assume_role_policy_doc" {
  statement {
...
data "aws_iam_policy" "c1_infra_aws_backup_service_policy" {
  arn = "arn:aws:iam::aws:policy/service-role/AWSBackupServiceRolePolicyForBackup"
}

data "aws_iam_policy" "c1_infra_aws_restore_service_policy" {
...
resource "aws_iam_role" "c1_infra_aws_backup_service_role" {
  name               = "c1AWSBackupServiceRole"
  description        = "Allows the AWS Backup Service to take scheduled backups"
  assume_role_policy = data.aws_iam_policy_document.c1_infra_aws_backup_service_assume_role_policy_doc.json
...
resource "aws_iam_role_policy" "c1_infra_backup_service_aws_backup_role_policy" {
  policy = data.aws_iam_policy.c1_infra_aws_backup_service_policy.policy
  role   = aws_iam_role.c1_infra_aws_backup_service_role.name
}


resource "aws_iam_role_policy_attachment" "c1_infra_restore_service_aws_backup_role_policy_attachment" {
  policy_arn = data.aws_iam_policy.c1_infra_aws_restore_service_policy.arn
  role       = aws_iam_role.c1_infra_aws_backup_service_role.name
}


resource "aws_iam_role_policy" "c1_infra_backup_service_pass_role_policy" {
